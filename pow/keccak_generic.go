// Package pow — pure Go keccakF23 fallback, always available.
// Used as the default on amd64 (where Go compiler generates sufficient code)
// and as the sole implementation on non-amd64 without platform assembly.
...
// keccakF23Generic is the pure Go fallback for non-amd64 or purego builds.
// It performs 23 rounds of Keccak-f[1600] (rounds 1..23, skipping round 0).
func keccakF23Generic(s *[25]uint64) {
	...
	for r := 1; r < 24; r++ {
		...
		b0 := a0; b10 := rotl64(a1, 1); b20 := rotl64(a2, 62); b5 := rotl64(a3, 28); b15 := rotl64(a4, 27)
		b16 := rotl64(a5, 36); b1 := rotl64(a6, 44); b11 := rotl64(a7, 6); b21 := rotl64(a8, 55); b6 := rotl64(a9, 20)
		b7 := rotl64(a10, 3); b17 := rotl64(a11, 10); b2 := rotl64(a12, 43); b12 := rotl64(a13, 25); b22 := rotl64(a14, 39)
		b23 := rotl64(a15, 41); b8 := rotl64(a16, 45); b18 := rotl64(a17, 15); b3 := rotl64(a18, 21); b13 := rotl64(a19, 8)
		b14 := rotl64(a20, 18); b24 := rotl64(a21, 2); b9 := rotl64(a22, 61); b19 := rotl64(a23, 56); b4 := rotl64(a24, 14)
